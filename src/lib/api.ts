...
const errorMessages: Record<string, string> = {
  ...
  ai_vision_test_required: '所选数据包含截图，请先确认对应 AI 模型已通过图片识别测试',
  ...
  custom_strategy_logic_required: '请完整填写开仓逻辑和持仓风控逻辑',
  custom_strategy_compile_failed: 'AI 未能生成有效的策略配置，请调整规则或更换模型后重试',
  custom_strategy_compile_unavailable: '策略分析服务暂不可用，请稍后重试',
  invalid_custom_strategy_compilation: '策略分析结果无效，请重新生成后再确认',
